    ...
    <div className="fixed inset-y-0 right-0 w-full sm:w-96 bg-white dark:bg-gray-800 shadow-lg border-l dark:border-gray-700 z-50 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="space-y-6">
            ...
            {isEditingTitle ? (
              <div className="space-y-2">
                <Input
                  ...
                  onChange={(e) => setEditedTask({ ...editedTask, title: e.target.value, nombre: e.target.value })}
              ...
              <div className="flex justify-between items-start">
                <h3 className="text-lg font-medium dark:text-gray-200">{editedTask.nombre || editedTask.title}</h3>
          ...
          {/* Course Code (Sigla) */}
          <div>
            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">Código</label>
            <Input
              value={editedTask.codigo || ""}
              onChange={(e) => setEditedTask({ ...editedTask, codigo: e.target.value })}
          ...
          {/* Credits */}
          <div>
            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">Créditos</label>
            <Input
              type="number"
              value={editedTask.creditos || 0}
              onChange={(e) => setEditedTask({ ...editedTask, creditos: Number.parseInt(e.target.value) || 0 })}
              className="dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
            />
          </div>
          ...
          {/* Category */}
          <div>
            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">Departamento</label>
            <Input
              value={editedTask.departamento || ""}
              onChange={(e) => setEditedTask({ ...editedTask, departamento: e.target.value })}
              className="dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
            />
          </div>
          ...
          {/* Semester */}
          <div>
            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">Semestre</label>
            <Input
              type="number"
              value={editedTask.semestre || 0}
              onChange={(e) => setEditedTask({ ...editedTask, semestre: Number.parseInt(e.target.value) || 0 })}
              className="dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
            />
          </div>
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">Horas</label>
            <Input
              type="number"
              value={editedTask.horas || 0}
              onChange={(e) => setEditedTask({ ...editedTask, horas: Number.parseInt(e.target.value) || 0 })}
              className="dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
            />
          </div>

          <div>
            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">Periodo</label>
            <Input
              value={editedTask.periodo || ""}
              onChange={(e) => setEditedTask({ ...editedTask, periodo: e.target.value })}
              className="dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
              placeholder="A, P, I"
            />
          </div>
